...
<body>
    ...
    <section class="home">
        <div class="text">
            <div class="Manage">
                <h1 class="display-4 mb-5">Items purchased</h1>
                ...
                <form action="" class="w-50" method="post">
                    ...
                    <div class="form-group">
                        <label for="b">Number purchased: </label>
                ...
                if (isset($_POST['SubmitButton'])) { //check if form was submitted
                    ...
                    if ($count == 1) {
                        $field3name = $field2name + $field2;
                        $sql = "UPDATE itemsavailable SET item_availability=$field3name WHERE item_name= '$field1name'";
                        $sql1="INSERT INTO reportdata (ActionDone, Item, NumberItem, AvailabilityR)
                            VALUES ('Purchased','{$field1}','{$field2}','{$field3name}')";
                            $con->query($sql1);
                        if ($con->query($sql) === TRUE) {
                            echo '<div class="alert alert-success mt-3" role="alert">Updated successfully</div>';
                        } else {
